"""
Django settings for ip_distribution project.
...
MIDDLEWARE = [
    ...
    'ip_distribution.middleware.cross_domain_middleware.CrossDomainMiddleware',
    'ip_distribution.middleware.exception_middleware.ExceptionMiddleware',
    'ip_distribution.middleware.http_log_middleware.HTTPLogMiddleware',
]

ROOT_URLCONF = 'ip_distribution.urls'
...
WSGI_APPLICATION = 'ip_distribution.wsgi.application'
...
AUTH_USER_MODEL = "distribution.User"
